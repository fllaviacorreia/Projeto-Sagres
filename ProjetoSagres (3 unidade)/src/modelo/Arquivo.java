...
public class Arquivo{
	 ...
	 * 
	 * 5 - professor
	 * 6 - realiza a verifica��o de todos os arquivos e preenche os arraylist's
	 * 
	 */
...
//				escreveArquivoAluno.write(TiraEspa�os(Main.aluno.get(i).getNome())+";");
...
//				escreveArquivoAluno.write(TiraEspa�os(Main.aluno.get(i).getOrgaoExp()+";"));
...
//				escreveArquivoProfessor.write(TiraEspa�os(Main.professor.get(i).getNome())+";");
...
//				escreveArquivoProfessor.write(TiraEspa�os(Main.professor.get(i).getOrgaoExp()));
...
//	}
	...
	public ArrayList<String> EscreveCidades(String estado) throws IOException{
		...
		if(arquivo.exists()) {
			...
			System.out.println("Arquivo das cidades do estado de" + estado + "n�o encontrado.");
		}
